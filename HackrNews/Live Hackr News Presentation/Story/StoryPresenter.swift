...
public final class StoryPresenter {
    ...
    public func didStartLoadingStory(from new: LiveHackrNew) {
        ...
        view.display(StoryViewModel(newId: new.id, title: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore", author: "Loading author...", comments: "Loading comments...", score: "Score", date: "Loading date..."))
