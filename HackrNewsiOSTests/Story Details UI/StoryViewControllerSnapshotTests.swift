...
final class StoryViewControllerSnapshotTests: XCTestCase {
    func test_details_storyWithOneLineTitle() {
        ...
        assert(snapshot: sut.snapshot(for: .iPhone12Mini(style: .dark)), named: "story_one_line_title_details_dark")
    }
